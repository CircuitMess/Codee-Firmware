...
Prompt::Prompt(LVScreen* parent, const char* text) : LVModal(parent){
	...
	lv_obj_set_style_border_width(textContainer, 1, 0);
	lv_obj_set_style_border_color(textContainer, lv_color_white(), 0);
	lv_obj_set_style_border_opa(textContainer, LV_OPA_100, 0);
	lv_obj_set_style_border_side(textContainer, (lv_border_side_t)(LV_BORDER_SIDE_FULL & ~LV_BORDER_SIDE_BOTTOM), 0);

	lv_obj_set_style_bg_color(textContainer, lv_color_hex(0x26648a), 0);
	lv_obj_set_style_bg_opa(textContainer, LV_OPA_100, 0);
...
//	lv_obj_set_style_text_font(label, &pixelbasic7, 0);
	...
	lv_obj_set_style_border_color(buttonContainer, lv_color_white(), 0);
	lv_obj_set_style_border_opa(buttonContainer, LV_OPA_100, 0);
	lv_obj_set_style_bg_color(buttonContainer, lv_color_hex(0x26648a), 0);
	lv_obj_set_style_bg_opa(buttonContainer, LV_OPA_100, 0);
